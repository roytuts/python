...
(function() {
    ...
    function _getExtents(data, key) {
        ...
        return{x: d3.extent(nData, function(d) {
                return d.x
    ...
    function xy(self, data, xType, yType) {
        var extents = _getExtents(data), scales = {}, o = self._options, horiz = [o.axisPaddingLeft, self._width], vert = [self._height, o.axisPaddingTop], xScale, yScale;
    ...
    (function() {
        ...
        _vis.cumulative = {preUpdateScale: preUpdateScale, enter: enter, update: line.update, exit: line.exit, destroy: destroy}
    })();
    var emptyData = [[]], defaults = {mouseover: function(data, i) {
        }, mouseout: function(data, i) {
        }, click: function(data, i) {
        }, axisPaddingTop: 0, axisPaddingRight: 0, axisPaddingBottom: 5, axisPaddingLeft: 20, paddingTop: 0, paddingRight: 0, paddingBottom: 20, paddingLeft: 60, tickHintX: 10, tickFormatX: function(x) {
            return x
        }, tickHintY: 10, tickFormatY: function(y) {
            return y
        ...
        }, timing: 750, interpolation: "monotone"};
    function svgEnabled() {
        var d = document;
    ...
    _.defaults(xChart.prototype, {setType: function(type, skipDraw) {
            var self = this;
            ...
            var self = this, callbacks = {click: self._options.click, mouseover: self._options.mouseover, mouseout: self._options.mouseout};
        ...
        }, _mainStorage: {}, _compStorage: {}, _draw: function() {
