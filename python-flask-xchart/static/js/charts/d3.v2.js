(function() {
    ...
    function d3_format_group(value) {
        ...
        while (i > 0)
            t.push(value.substring(i -= 3, i + 3));
        ...
        if (n < 3) {
            if (typeof name !== "string") {
                if (n < 2)
                    value = "";
                for (priority in name)
                    this.styleTween(priority, d3_tweenByName(name[priority], priority), value);
                return this;
            }
            priority = "";
        }
    ...
    d3.layout.force = function() {
        ...
        force.drag = function() {
            if (!drag)
                drag = d3.behavior.drag().origin(d3_identity).on("dragstart", dragstart).on("drag", d3_layout_forceDrag).on("dragend", d3_layout_forceDragEnd);
    ...
    d3.geo.path = function() {
        ...
        var pathType = d3_geo_type({
            FeatureCollection: function(o) {
                ...
                while (++i < n)
                    buffer.push(pathType(features[i].geometry));
            },
            Feature: function(o) {
                pathType(o.geometry);
            },
            ...
            LineString: function(o) {
                ...
                buffer.push("M");
                while (++i < n)
                    buffer.push(project(coordinates[i]), "L");
                buffer.pop();
            },
            ...
            GeometryCollection: function(o) {
                ...
                while (++i < n)
                    buffer.push(pathType(geometries[i]));
            }
        });
    ...
    d3.geo.greatArc = function() {
        ...
        greatArc.target = function(_) {
            ...
            target = _;
            if (typeof target !== "function")
                interpolate.target(p1 = target);
            return greatArc;
        };
        greatArc.precision = function(_) {
            if (!arguments.length)
                return precision / d3_geo_radians;
